...
public class ChatServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ChatServiceOuterClass.Message,
      ChatServiceOuterClass.Response> METHOD_SEND_MESSAGE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ChatService", "SendMessage"),
          io.grpc.protobuf.ProtoUtils.marshaller(ChatServiceOuterClass.Message.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ChatServiceOuterClass.Response.getDefaultInstance()));
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessage(ChatServiceOuterClass.Message request,
        io.grpc.stub.StreamObserver<ChatServiceOuterClass.Response> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ChatServiceOuterClass.Message,
                ChatServiceOuterClass.Response>(
  ...
  public static final class ChatServiceBlockingStub extends io.grpc.stub.AbstractStub<ChatServiceBlockingStub> {
    ...
    /**
     */
    public ChatServiceOuterClass.Response sendMessage(ChatServiceOuterClass.Message request) {
  ...
  public static final class ChatServiceFutureStub extends io.grpc.stub.AbstractStub<ChatServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ChatServiceOuterClass.Response> sendMessage(
        ChatServiceOuterClass.Message request) {
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public MethodHandlers(ChatServiceImplBase serviceImpl, int methodId) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((ChatServiceOuterClass.Message) request,
              (io.grpc.stub.StreamObserver<ChatServiceOuterClass.Response>) responseObserver);
          break;
        default:
